  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8">
      <section className="luxury-gradient rounded-[2.5rem] p-8 text-white md:p-12">
        ...
        <h1 className="mt-3 font-display text-5xl font-semibold">Hair artistry with a polished finish.</h1>
      ...
      <section className="mt-10 grid gap-4 md:grid-cols-2">
        {services.map((service, index) => (
          <article key={service.name} className="rounded-[2rem] bg-white p-6 shadow-sm ring-1 ring-amber-900/10">
